...
const byte  boot_A_[] = {			// Payload A image (S210718 uBIOS + Basic)
...
const word  boot_A_size = sizeof( boot_A_ );
#endif

#if 1
//const word  boot_B_StrAddr = 0xfd10;// Payload B image starting address
const byte  boot_B_[] =	{			// Payload B image (S200718 iLoad)
...
const word  boot_B_size = sizeof( boot_B_ );
#endif

#if 0
//const word  boot_C_StrAddr = 0x0100;// Payload C image starting address
const byte  boot_C_[] =	{			// Payload C image (Forth)
...
const word  boot_C_size = sizeof( boot_C_ );
#endif
